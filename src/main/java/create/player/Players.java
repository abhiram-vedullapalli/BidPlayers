...
public Players(String playerName, String playerAge, long playerPrice, String playerTeam, String playerOwner , String playerImage) {
...
public Players(String playerName,String playerImage, String playerAge, long playerPrice) {
	this.playerName = playerName;
	this.playerImage = playerImage;
	this.playerAge = playerAge;
	this.playerPrice = playerPrice;
